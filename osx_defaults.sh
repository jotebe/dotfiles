...
## Set the size of the system kill ring
defaults write -g NSTextKillRingSize -string 4

## Bind C-u for emacs-style prefix argument for repeating commands
...
## Enable spring loading for directories (drag something onto a directory and then you can see contents and dive in further)
...
## Hot corners (defaults to nothing)
# Possible values:
#  0: no-op
#  2: Mission Control
